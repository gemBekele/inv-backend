...
export class Migrations1761048004136 implements MigrationInterface {
    name = 'Migrations1761048004136'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "branches" DROP CONSTRAINT "FK_a35729a94e7280cbebaaa541a20"`);
        await queryRunner.query(`ALTER TABLE "transfers" DROP CONSTRAINT "FK_transfers_accepted_by"`);
        await queryRunner.query(`ALTER TABLE "transfers" DROP CONSTRAINT "FK_transfers_delivered_by"`);
        ...
        await queryRunner.query(`ALTER TABLE "transfers" DROP COLUMN "sourceWarehouseId"`);
        await queryRunner.query(`ALTER TABLE "transfers" DROP COLUMN "sourceShopId"`);
        await queryRunner.query(`ALTER TABLE "transfers" DROP COLUMN "destinationWarehouseId"`);
        await queryRunner.query(`ALTER TABLE "transfers" DROP COLUMN "destinationShopId"`);
        ...
        await queryRunner.query(`ALTER TABLE "transfers" ADD "sourceLocationId" uuid NOT NULL`);
        await queryRunner.query(`CREATE TYPE "public"."transfers_sourcelocationtype_enum" AS ENUM('warehouse', 'shop')`);
        await queryRunner.query(`ALTER TABLE "transfers" ADD "sourceLocationType" "public"."transfers_sourcelocationtype_enum" NOT NULL`);
        await queryRunner.query(`ALTER TABLE "transfers" ADD "destinationLocationId" uuid NOT NULL`);
        await queryRunner.query(`CREATE TYPE "public"."transfers_destinationlocationtype_enum" AS ENUM('warehouse', 'shop')`);
        await queryRunner.query(`ALTER TABLE "transfers" ADD "destinationLocationType" "public"."transfers_destinationlocationtype_enum" NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "transfers" ADD CONSTRAINT "FK_transfers_source_location" FOREIGN KEY ("sourceLocationId") REFERENCES "warehouses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "transfers" ADD CONSTRAINT "FK_transfers_destination_location" FOREIGN KEY ("destinationLocationId") REFERENCES "warehouses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "transfers" DROP CONSTRAINT "FK_ee8b09cc81b73c15214a8f2ff1a"`);
        await queryRunner.query(`ALTER TABLE "transfers" DROP CONSTRAINT "FK_ee8b09cc81b73c15214a8f2ff1a"`);
        await queryRunner.query(`ALTER TABLE "transfers" DROP CONSTRAINT "FK_7d88c2d9da2da8753207be13008"`);
        await queryRunner.query(`ALTER TABLE "transfers" DROP CONSTRAINT "FK_7d88c2d9da2da8753207be13008"`);
        await queryRunner.query(`ALTER TABLE "suppliers" DROP CONSTRAINT "FK_a16f3c2e9b291abc6790e9822ae"`);
        await queryRunner.query(`ALTER TABLE "branches" DROP CONSTRAINT "FK_a35729a94e7280cbebaaa541a20"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5b5720d9645cee7396595a16c9"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_9c1a78b27ce1426491f175e034"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3b2beba6a393519038d64b12ed"`);
        await queryRunner.query(`CREATE TYPE "public"."transfers_status_enum_old" AS ENUM('accepted', 'approved', 'cancelled', 'completed', 'delivered', 'in_transit', 'pending', 'rejected', 'requested')`);
        await queryRunner.query(`ALTER TABLE "transfers" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."transfers_type_enum_old" AS ENUM('external', 'internal', 'shop_to_shop', 'shop_to_warehouse', 'warehouse_to_shop', 'warehouse_to_warehouse')`);
        ...
        await queryRunner.query(`ALTER TABLE "transfers" DROP COLUMN "destinationLocationType"`);
        await queryRunner.query(`DROP TYPE "public"."transfers_destinationlocationtype_enum"`);
        await queryRunner.query(`ALTER TABLE "transfers" DROP COLUMN "destinationLocationId"`);
        await queryRunner.query(`ALTER TABLE "transfers" DROP COLUMN "sourceLocationType"`);
        await queryRunner.query(`DROP TYPE "public"."transfers_sourcelocationtype_enum"`);
        await queryRunner.query(`ALTER TABLE "transfers" DROP COLUMN "sourceLocationId"`);
        await queryRunner.query(`ALTER TABLE "suppliers" DROP COLUMN "companyId"`);
        await queryRunner.query(`ALTER TABLE "suppliers" DROP COLUMN "emergencyContact"`);
        await queryRunner.query(`ALTER TABLE "branches" DROP COLUMN "companyId"`);
        await queryRunner.query(`ALTER TABLE "suppliers" ADD "companyId" uuid`);
        await queryRunner.query(`ALTER TABLE "suppliers" ADD "emergencyContact" json`);
        await queryRunner.query(`ALTER TABLE "transfers" ADD "destinationShopId" uuid`);
        await queryRunner.query(`ALTER TABLE "transfers" ADD "destinationWarehouseId" uuid`);
        await queryRunner.query(`ALTER TABLE "transfers" ADD "sourceShopId" uuid`);
        await queryRunner.query(`ALTER TABLE "transfers" ADD "sourceWarehouseId" uuid`);
        await queryRunner.query(`ALTER TABLE "branches" ADD "companyId" uuid`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_85f92bfee8f136fab50cc3feb7" ON "suppliers" ("name", "companyId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_9c1a78b27ce1426491f175e034" ON "suppliers" ("email", "companyId") WHERE (email IS NOT NULL)`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_3b2beba6a393519038d64b12ed" ON "branches" ("name", "companyId") `);
        ...
        await queryRunner.query(`ALTER TABLE "transfers" ADD CONSTRAINT "FK_transfers_delivered_by" FOREIGN KEY ("deliveredById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "transfers" ADD CONSTRAINT "FK_transfers_accepted_by" FOREIGN KEY ("acceptedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "branches" ADD CONSTRAINT "FK_a35729a94e7280cbebaaa541a20" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
